...
from .forms import LoginForm,MyPasswordResetForm,MyPasswordChangeForm,MySetPasswordForm,PasswordChangeForm
...
urlpatterns = [
    ...
    path('category/<slug:val>/',views.CategoryView.as_view(),name="category1"),
    path('product-detail/<int:pk>/',views.productdetail.as_view(),name="product-detail"),
    path('categorytitle/<val>/',views.categorytitle.as_view(),name="category-detail"),
